...
const SOURCE_CANDIDATES = [
  path.join(__dirname, '..', 'target', 'release', 'libsolder_node.node'),
  path.join(__dirname, '..', 'target', 'release', 'libsolder_node.dylib'),
  path.join(__dirname, '..', 'target', 'release', 'libsolder_node.so'),
  path.join(__dirname, '..', 'target', 'release', 'solder_node.node'),
...
function copyAddon() {
  ...
  if (!source) {
    ...
    console.error('  cargo build --release -p solder-node');
    console.error(`\nSearched locations:`);
