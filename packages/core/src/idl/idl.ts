...
export type DecodedEvent = {
  ...
  name: string;
  type: "event";
  params: EventType<typeof IDL_DATA_DICT["PUMP_FUN"], "CreateEvent">;
};
...
export function getInstructionCoder(programId: string): BorshInstructionCoder | null {
  const key = programId;
...
export function decodeInstruction(data: string, programId: string): DecodedInstruction {
...
export const decodeEvent = (data: string, programId: string): DecodedEvent | null => {
